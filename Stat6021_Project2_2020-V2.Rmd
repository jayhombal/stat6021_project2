...
* Based on the analysis -
  + The model with lowest BIC was: $$ charges = \beta_0 + \beta_1 age + \beta_2 bmi + \beta_3 children + \beta_4 smokeyes $$
...
$$ charges = \beta_0 + \beta_1 age + \beta_2 bmi + \beta_3 children + \beta_4 smokeyes + \beta_5 regionnorthwest + \beta_6 region5southeast + \beta_7 regionsouthwest + \beta_8 sex $$
